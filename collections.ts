...
export class ByteArray extends Uint8Array {
  ...
  // @operator('<')
  // lt(other: ByteArray): boolean {
  //   return Uint8Array.lt.apply(this,other)
  //   // let a = <Uint8Array>this
  //   // let b = <Uint8Array>other
  //   // return a < b
  // }
  //
  // @operator('>')
  // gt(other: ByteArray): boolean {
  //   return Uint8Array.gt.apply(this,other)
...
export class Bytes extends ByteArray {
  // @operator('<')
  // lt(other: Bytes): boolean {
  //   return super.lt(other)
  //   // let a = <ByteArray>this
  //   // let b = <ByteArray>other
  //   // return a < b
  // }
  // @operator('>')
  // gt(other: Bytes): boolean {
  //   return super.gt(other)
  //   // let a = <ByteArray>this
  //   // let b = <ByteArray>other
  //   // return a < b
